function declare_items()
{
	...
	global.items = 
	{
		...
		ITEM_MONSTER_CANDY: new consumable_item(10,25,,,{dialogue_event: function(this) {with this { if array_length(global.stats.party) == 1 use_description = use_description[irandom(15) <= 2] else use_description_party = use_description_party[irandom(15) <= 2]} }}),
