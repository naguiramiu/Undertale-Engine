...
draw_text(top_x + 39, top_y + 57,selected_char.name)
draw_set_font(font_crypt_4)
draw_text_linesep(top_x + 46 + -7,top_y +102 + -25,[lan.lv_lan,lan.hp_lan,lan.gold_lan],9,1)
draw_text_linesep(top_x + 46 + 18 + -7,top_y +102 + -25,[string(global.stats.lv),string(selected_char.hp) + "/" + string(selected_char.max_hp),global.stats.gold],9,1)
...
array_push(grayed_menu,e_mainmenu.item)
...
if (!in_submenu || main_menu_selection == e_mainmenu.stat)
