...
var set_frame = function(img) {return [variable_instance_set,obj_titleboards,"image_index",img]}
var write_text = function(dialogue)
{	
	cutscene_hold_arguments
	create_textbox(dialogue,obj_titleboards.dialogue_var_struct)
	cutscene_pause()
} 
...
{ 
	cutscene_hold_arguments
	cutscene_pause(obj_titleboards.main_cutscene)
...
var fade = function(_start,_end,spd = 0.075) {return [cut_interpolate_var,obj_titleboards,"image_alpha",spd,_start,_end,0]}
