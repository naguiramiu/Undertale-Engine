...
array_remove_value_ext(room_info,function(i) {return array_contains([rm_setup,rm_titlescreen,rm_deathscreen,rm_dogcheck,rm_title_story], room_info[i].room_id)})
